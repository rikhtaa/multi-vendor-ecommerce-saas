...
const ForgotPassword = () => {
    ...
    const resetPasswordMutation = useMutation({
        ...
        onSuccess: () => {
            setStep("email")
            toast.success(
                "Password reset successfully! Please login with yout new password."
            )
            setServerError(null)
            router.push("/login")
        },
    ...
    const onSubmitReset = ({ password }: { password: string }) => {
                    ...
                    {step === "otp" && (
                     <>
                       <h3 className='text-xl font-semibold text-center mb-4'>
                        ...
                        disabled={verifyOtpMutation.isPaused}
                    ...
                    {step === "reset" && (
                      <>
                       ...
                       <form onSubmit={handleSubmit(onSubmitReset)}>
                        ...
                        >
                            {resetPasswordMutation.isPending ? "Loggin in..." : "Login"}
                        </button>
                        {serverError && (
                            <p className="text-red-500 text-sm mt-2">{serverError}</p>
                        )}
