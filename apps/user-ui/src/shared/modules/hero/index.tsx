    ...
    <div className='h-[85vh] bg-[#115061] flex flex-col justify-center w-full'>
       <div className="md:w-[80%] w-[90%] mx-auto md:flex h-full items-center">
         ...
         <div className="md:w-1/2 flex justify-center">
          <Image
           src={"https://images.unsplash.com/photo-1546868871-7041f2a55e12?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
           alt=""
           width={450}
           height={450}
           />
