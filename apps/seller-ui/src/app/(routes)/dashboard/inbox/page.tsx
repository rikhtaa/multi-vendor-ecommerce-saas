                                ...
                                return (
                                    ...
                                    >
                                        <div className="relative flex-shrink-0">
                                            <Image
                                                src={chat.seller?.avatar || "https://plus.unsplash.com/premium_vector-1719858611039-66c134efa74d?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                                                alt={chat.seller?.name || "User"}
                                                width={38}
                                                height={38}
