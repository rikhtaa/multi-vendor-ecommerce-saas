...
const Page = () => {
    ...
    const onSubmit = async (data: any) => {
        setLoading(true)
        try {
            await axiosInstance.post("/product/api/create-event", data)
                    ...
                    <div className="w-full flex gap-6">
                        ...
                        <div className="w-2/4">
                            ...
                            {errors.title && (
                                <p className="text-red-500 text-xs mt-1">
                                    {String(errors.title.message as string)}
                                </p>
                            )}
                            ...
                            <div className="mt-2">
                                ...
                                {errors.short_description && (
                                    <p className="text-red-500 text-xs mt-1">
                                        {String(errors.short_description.message as string)}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="mt-2">
                                <Input
                                    label='Tags *'
                                    placeholder='sale, flash-deal'
                                    {...register("tags", { required: "Seperate related event tags with a coma," })}
                                />
                                {errors.tags && (
                                    <p className="text-red-500 text-xs mt-1">
                                        {String(errors.tags.message as string)}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="mt-2">
                                ...
                                {errors.warranty && (
                                    <p className="text-red-500 text-xs mt-1">
                                        {String(errors.warranty.message as string)}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="mt-2">
                                <Input
                                    ...
                                    {...register("slug", {
                                        ...
                                        pattern: {
                                            value: /^[a-z0-9]+(?:-[a-z0-9]+)*$/,
                                            message:
                                                "Invalid slug format! Use only lowercase letters, numbers, and hyphens (e.g. my-event-name)."
                                        },
                                        minLength: {
                                            value: 3,
                                ...
                                {errors.slug && (
                                    <p className="text-red-500 text-xs mt-1">
                                        {String(errors.slug.message as string)}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="mt-2">
                                ...
                                {errors.brand && (
                                    <p className="text-red-500 text-xs mt-1">
                                        {String(errors.brand.message as string)}
                                    </p>
                                )}
                            </div>
                        ...
                        <div className="w-2/4">
                            ...
                            {isLoading ? (
                                ...
                                <p className="text-gray-400">Failed to load categories...</p>
                            ) : (
                                <Controller
                                    name="category"
                                    control={control}
                            ...
                            <div className="mt-2">
                                ...
                                {isLoading ? (
                                    ...
                                    <p className="text-gray-400">Failed to load Subcategories...</p>
                                ) : (
                                    <Controller
                                        name="Subcategory"
                                        control={control}
                                ...
                                <Input
                                    ...
                                    {...register("video_url", {
                                        validate: (value) => {
                                            ...
                                            return /^https:\/\/www\.youtube\.com\/embed\/[\w-]+$/.test(value) ||
                                    ...
                                    {...register("sale_price", {
                                        ...
                                        validate: (value) => {
                                            ...
                                            if (regularPrice && value >= regularPrice) {
                                                return "Sale Price must be less than Regualr Price"
                                            }
                                            return true
                                        }
                                    })}
                                ...
                                {DiscountLoading ? (
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {discountCodes?.map((code: any) => (
                                            ...
                                            ${watch("discountCodes")?.includes(code.id) ? "bg-blue-600 text-white border-blue-600" : "bg-gray-800 text-gray-300 border-gray-600 hover:bg-gray-700"
                                                    }`}
                                                onClick={() => {
                    ...
                    <div className="bg-gray-800 p-6 rounded-lg w-[450px] text-white">
                        ...
                        {selectedImage && (
                            <div className="mt-4 space-y-2">
                                ...
                                <div className="grid grid-cols-2 mx-h-[250px] overflow-y-auto">
