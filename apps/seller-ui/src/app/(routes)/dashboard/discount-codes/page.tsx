...
const Page = () => {
  ...
  const onSubmit = (data: any) => {
    if (discountCodes.length >= 8) {
      toast.error("You can only create up tp 8 discount codes. ")
      return
    }
          ...
          <table className='w-full text-white'>
            ...
            <tbody>
              {discountCodes?.map((discount: any) => (
                <tr key={discount?.id}
                  className='border border-gray-800 hover:bg-gray-800 transition'
                >
        ...
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-gray-800 p-6 rounded-lg w-[450px] shadow-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='mt-4'>
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <option value="Percentage" className="bg-black text-white">
                        Percentage (%)
                      </option>
                      <option value="flat" className="bg-black text-white">
                        Flat Amount ($)
                      </option>
                    </select>
                  )}
              ...
              className="flex justify-center items-center mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-md font-semibold">
                <Plus size={18} />
